  ...
  constructor(props) {
    ...
    if (JSON.parse(window.localStorage.getItem("data"))) {
      ...
      this.state = {
        ...
        striker_batsman: JSON.parse(window.localStorage.getItem("data"))
          .striker_batsman,
        non_striker_batsman: JSON.parse(window.localStorage.getItem("data"))
          .non_striker_batsman,
        current_bowler: JSON.parse(window.localStorage.getItem("data"))
          .current_bowler,
        previous_bowler: JSON.parse(window.localStorage.getItem("data"))
          .previous_bowler,
        team2_players: JSON.parse(window.localStorage.getItem("data"))
          .team2_players,
        team1_players: JSON.parse(window.localStorage.getItem("data"))
          .team1_players,
        batting_team: JSON.parse(window.localStorage.getItem("data"))
          .batting_team,
        bowling_team: JSON.parse(window.localStorage.getItem("data"))
          .bowling_team,
        bowling_team_score: JSON.parse(window.localStorage.getItem("data"))
          .bowling_team_score,
        bowling_team_wickets: JSON.parse(window.localStorage.getItem("data"))
          .bowling_team_wickets,
        batting_team_score: JSON.parse(window.localStorage.getItem("data"))
          .batting_team_score,
        batting_team_wickets: JSON.parse(window.localStorage.getItem("data"))
          .batting_team_wickets,
        total_overs: JSON.parse(window.localStorage.getItem("data"))
          .total_overs,
        previous_team_overs: JSON.parse(window.localStorage.getItem("data"))
          .previous_team_overs,
        balls_per_over: JSON.parse(window.localStorage.getItem("data"))
          .balls_per_over,
        striker: {
          out_by: JSON.parse(window.localStorage.getItem("data")).striker
            .out_by,
          ...
          strike_rate: JSON.parse(window.localStorage.getItem("data")).striker
            .strike_rate,
        ...
        non_striker: {
          runs: JSON.parse(window.localStorage.getItem("data")).non_striker
            .runs,
          balls: JSON.parse(window.localStorage.getItem("data")).non_striker
            .balls,
          strike_rate: JSON.parse(window.localStorage.getItem("data"))
            .non_striker.strike_rate,
          fours: JSON.parse(window.localStorage.getItem("data")).non_striker
            .fours,
          sixes: JSON.parse(window.localStorage.getItem("data")).non_striker
            .sixes,
        },
        bowler: {
          balls: JSON.parse(window.localStorage.getItem("data")).bowler.balls,
          maiden_count: JSON.parse(window.localStorage.getItem("data")).bowler
            .maiden_count,
          overs: JSON.parse(window.localStorage.getItem("data")).bowler.overs,
          maidens: JSON.parse(window.localStorage.getItem("data")).bowler
            .maiden_count,
          runs: JSON.parse(window.localStorage.getItem("data")).bowler.runs,
          wickets: JSON.parse(window.localStorage.getItem("data")).bowler
            .wickets,
        },
        p_bowler: {
          balls: JSON.parse(window.localStorage.getItem("data")).p_bowler.balls,
          maiden_count: JSON.parse(window.localStorage.getItem("data")).p_bowler
            .maiden_count,
          overs: JSON.parse(window.localStorage.getItem("data")).p_bowler.overs,
          maidens: JSON.parse(window.localStorage.getItem("data")).p_bowler
            .maiden_count,
          runs: JSON.parse(window.localStorage.getItem("data")).p_bowler.runs,
          wickets: JSON.parse(window.localStorage.getItem("data")).p_bowler
            .wickets,
        },
      ...
      <Container>
        ...
        <Grid align="center">
          <Typography align="center">
            ...
            {this.state.balls_per_over} Overs) // {this.state.bowling_team}{" "}
            {this.state.bowling_team_score}/{this.state.bowling_team_wickets}
          </Typography>
          <Button
            variant="contained"
            color="primary"
        ...
        <Grid container spacing={10}>
          ...
          <Grid item align="center">
            ...
            <Button
              ...
              size="medium"
              color="primary"
              onClick={this.openAddInitialPlayerForm}
        ...
        >
          ...
          <DialogContent>Please select players first.</DialogContent>
          <DialogActions>
            <Button
              onClick={() => {
